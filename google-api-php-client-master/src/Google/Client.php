...
require_once 'Google/Auth/AssertionCredentials.php'; //->oauth2 (2)
require_once 'Google/Cache/File.php'; //-->no (cache on disk)
require_once 'Google/Cache/Memcache.php'; //-->no (cache on disk)
require_once 'Google/Config.php'; // (1 TODO)
require_once 'Google/Collection.php'; // (1 not for now)
require_once 'Google/Exception.php'; // (1 not for now)
require_once 'Google/IO/Curl.php'; //-->no (http request)
require_once 'Google/IO/Stream.php'; //-->no (http request)
require_once 'Google/Model.php'; // (1 not for now)
require_once 'Google/Service.php'; // (1 not for now)
require_once 'Google/Service/Resource.php'; //-> to call the services (3)
